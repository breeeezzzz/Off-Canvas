		...
		<div class="container">
			...
			<div class="row">
			  ...
			  <div class="span-12">
				  ...
				  <h1 class="heavy"><span>Adventures in </span>Responsive Navigation</h1>
...
<footer class="footer">
    ...
    <script src="http://localhost/foundation-vanilla/bower_components/jquery/dist/jquery.min.js"></script>
    <script src="http://localhost/foundation-vanilla/bower_components/foundation/js/foundation.min.js"></script>
    <script src="http://localhost/foundation-vanilla/js/app.js"></script>
	<script>
